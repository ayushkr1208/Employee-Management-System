...
const FailedTask = ({data}) => {
  return (
    <div className='rounded-2xl shadow-lg bg-gradient-to-br from-yellow-400 to-red-200 p-6 flex flex-col h-full min-h-[320px]'>
      ...
      <div className='mt-6'>
        <button className='w-full bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold py-2 px-3 text-xs shadow transition'>Failed</button>
      </div>
    </div>
  )
}
